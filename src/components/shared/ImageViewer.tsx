  ...
  return (
    <>
      ...
      <div className="safe-bottom absolute inset-x-0 bottom-0 z-10 flex items-center gap-3 px-4 py-3">
        ...
        <button type="button" onClick={done} disabled={busy} className="flex min-h-[3.25rem] items-center gap-2.5 rounded-full bg-gold px-5 py-3.5 text-[15px] font-bold text-on-accent disabled:opacity-50">
          <Send size={18} />Enviar
        </button>
      </div>
    </>
