...
import { CalendarDays, FileBarChart, User, LogOut, Shirt, LifeBuoy, Radio, Building2, Bell, Users2, Siren, CalendarCheck } from "lucide-react";
...
export default function More() {
  ...
  const items = [
    ...
    { icon: <CalendarCheck size={20} />, label: t("attendance.title", "Asistencia"), to: "/supervisor/attendance" },
