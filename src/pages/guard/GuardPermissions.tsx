...
export default function GuardPermissions() {
  ...
  const items: { kind: Kind; icon: any; title: string; why: string }[] = [
    { kind: "location", icon: <MapPin size={20} />, title: t("perm.location", "Ubicación (GPS)"), why: t("perm.locationWhy", "CGuardPro recopila tu ubicación mientras estás en turno para el seguimiento en vivo y tu ruta de patrullaje, incluso con la app cerrada o la pantalla bloqueada. Se detiene al marcar salida. Elige “Permitir todo el tiempo”.") },
